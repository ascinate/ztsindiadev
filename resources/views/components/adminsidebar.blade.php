    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <span class="menu-title">Manage Consultation</span>
          ...
          <div class="collapse" id="ui-basic10">
            ...
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="{{ URL::to('consultations') }}">Consultation List</a></li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic12">
            ...
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="{{ URL::to('contentnews') }}">News List</a></li>
