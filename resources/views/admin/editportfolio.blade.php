   ...
   <x-adminsidebar/>
        ...
        <div class="main-panel">
          ...
          <div class="content-wrapper">
                ...
                <form name="editfrm" action="{{ route('portfolio.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data" class="forms-sample">
                    @csrf                  
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Date</label>
                                                <input type="date" class="form-control" name="date" value="{{ $portfolio->date }}">
                                            </div>
                                        </div>
                                    </div>
