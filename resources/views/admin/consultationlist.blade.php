                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <form action="{{ URL::to('ConsultationDelete') }}" method="POST" onsubmit="return confirm('Are you sure you want to delete selected brands?');">
                                  @csrf
                                  ...
                                  <table class="table cm-lisrt01" id="example2">
                                      ...
                                      <tbody>
                                             @foreach ($consultations as $consultation)
                                              <tr>
                                                  <td>
                                                      <input type="checkbox" name="consultation_ids[]" value="{{ $consultation->id }}" class="checkbox">
                                                  </td>
